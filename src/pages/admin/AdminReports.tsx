...
import {
  reportPageTabs,
  statsMapForAdminUserStats,
  statsMapForApplications,
  statsMapForRevenue,
} from "@/utils/constants";
import {
  applicationConfig,
  radialChartConfig,
  reportUserDummyDataConfig,
  revenueDummyDataConfig,
} from "@/utils/chartConfig";
import {
  adminFetchApplicationsReportStatsData,
  adminFetchReportApplicationGraphData,
  adminFetchReportPaymentsGraphData,
  AdminFetchReportTableData,
  adminFetchReportUserGraphData,
  adminFetchRevenueReportStatsData,
...
import {
  ...
  type AdminFetchReportTableDataResponse,
  type AdminFetchReportUserswGraphsDataResponse,
  type AdminFetchRevenueReportStatsDataResponse,
  type AdminFetchUserReportStatsDataResponse,
    ...
    <div className="space-y-8 text-black dark:text-white mt-4">
      ...
      {activeTab == "users" && (
        <>
          <Heading
            heading="Stats"
            headingDescription="Detailed user stats"
      ...
      {activeTab == "applications" && (
        <>
          <Heading
            heading="Stats"
            headingDescription="Detailed applications stats"
            mainDivClassName="w-6/12"
          />
      ...
      {activeTab == "revenue" && (
        <>
          <Heading
            heading="Stats"
            headingDescription="Detailed payment and revenue stats"
            mainDivClassName="w-6/12"
          />
          ...
          {activeTab == "users" && (
            <>
              <RadialChart
                ...
                chartData={
                  (reportGraphData as AdminFetchReportUserswGraphsDataResponse)
          ...
          {activeTab === "applications" && (
            <>
              <RadialChart
                ...
                chartData={
                  (
                    reportGraphData as AdminFetchReportApplicationsGraphsDataResponse
                  ).applicationRadialGragphData
                }
                dataKeyOne="count"
                dataKeyTwo="day"
                chartConfig={radialChartConfig}
          ...
          {activeTab === "revenue" && (
            <>
              <RadialChart
                ...
                chartData={
                  (
                    reportGraphData as AdminFetchReportPaymentsGraphsDataResponse
      ...
      <Heading
        ...
        headingDescription="Detailed report table data"
        mainDivClassName="w-6/12"
      />
      <div className="p-4 border rounded-xl shadow bg-white dark:bg-[#171717]">
        ...
        <>
          ...
          <div className="space-x-4">
            <Button
              variant={"outline"}
              onClick={(e) => handleExportExcel(e, reportData!, activeTab)}
            >
              Generate PDF
            </Button>
            <Button
              variant={"outline"}
              onClick={(e) => handleExportPDF(e, reportData!, activeTab)}
            >
              Generate Excel
            </Button>
          </div>
