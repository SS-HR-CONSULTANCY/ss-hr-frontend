    ...
    return (
        <div className="w-full p-8">
            ...
            <div className="space-y-1 mt-4">
                ...
                <InfoDisplay label="Professional Status" value={data?.userData?.professionalStatus} />
                <InfoDisplay label="Date of Birth" value={data?.userData?.dob} isDate />
                <InfoDisplay label="Resume" value={data?.userData?.resume as string} link />
                <InfoDisplay label="LinkedIn Username" value={data?.userData?.linkedInUsername} />
                <InfoDisplay label="Phone" value={data?.userData?.phone} />
                <InfoDisplay label="Phone (Secondary)" value={data?.userData?.phoneTwo} />
                <InfoDisplay label="Portfolio URL" value={data?.userData?.portfolioUrl} link />
                <InfoDisplay label="Serial Number" value={data?.userData?.serialNumber} />
            </div>
            ...
            {data?.address && (
                <div className="space-y-1 mt-6">
                    ...
                    <InfoDisplay label="Address Line 1" value={data.address.addressLine1} />
                    <InfoDisplay label="Address Line 2" value={data.address.addressLine2} />
            ...
            {data?.careerData && (
                <div className="space-y-1 mt-6">
                    ...
                    <InfoDisplay label="Current Company" value={data.careerData.currentCompany} />
                    <InfoDisplay label="Designation" value={data.careerData.currentDesignation} />
                    <InfoDisplay label="Industry" value={data.careerData.industry} />
                    <InfoDisplay label="Experience" value={data.careerData.experience} />
                    <InfoDisplay label="Current Salary" value={data.careerData.currentSalary} />
                    <InfoDisplay label="Expected Salary" value={data.careerData.expectedSalary} />
                    <InfoDisplay label="Job Type" value={data.careerData.currentJobType} />
                    <InfoDisplay label="Preferred Job Types" value={data.careerData.preferredJobTypes?.join(", ")} />
                    <InfoDisplay label="Preferred Work Modes" value={data.careerData.preferredWorkModes?.join(", ")} />
                    <InfoDisplay label="Immediate Joiner" value={data.careerData.immediateJoiner ? "Yes" : "No"} />
                    <InfoDisplay label="Notice Period" value={data.careerData.noticePeriod} />
                </div>
            )}
        </div>
