        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="prata-regular text-2xl text-primary-600">
                SS HR Consultancy
              </h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <p className="text-gray-600">
            Hello {user.firstName}, we're glad to have you here. Explore our HR services and find the perfect opportunities.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="text-sm text-gray-600">
                  ...
                  <div className="ml-5 text-xs text-gray-500 mt-1">
