...
import {
  ...
  type UpdateApplicationStatusForm,
} from "@/utils/zod/adminZod";
import {
      ...
      <div className="w-full mt-2">
        ...
        <div className="space-y-1">
          ...
          <form
            ...
            className="flex items-end space-x-2 p-2 max-1/2"
          >
          ...
          <InfoDisplay
            ...
            value={userId?.professionalStatus}
          />
          ...
          <InfoDisplay
            ...
            value={userId?.linkedInUsername}
          />
          <InfoDisplay
            label="Portfolio Url"
            value={userId?.portfolioUrl}
            link
          />
