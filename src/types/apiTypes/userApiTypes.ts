...
// User Career Data
export type CreateUserCareerDataRequest = Partial<
  Pick<
    CareerData,
    | "currentSalary"
    | "expectedSalary"
  ...
  >
>;
export type UpdateUserCareerDataRequest = Partial<
  Pick<
    CareerData,
    | "_id"
    | "currentSalary"
...
export type UserfetchAllJobsResponse = Pick<
  Job,
  "_id" | "designation" | "vacancy" | "createdAt" | "jobUniqueId"
> & {
  applied: boolean;
};
...
export type UserFetchJobDetailsResponse = Omit<
  Job,
  "updatedAt" | "compnayName"
>;

// User application Update
export type UserUpdateApplicationStatusRequest = Pick<
  Application,
  "_id" | "status"
>;
...
export type UserFetchAllApplicationsResponse = Pick<
  Job,
