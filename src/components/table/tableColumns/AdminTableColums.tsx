  ...
  [
    {
      accessorKey: "text",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title="Review Content" />
      ),
    },
    {
...
export const AdminApplicationsTableColumns: ColumnDef<AdminfetchAllApplicationsResponse>[] =
  [
    ...
    },
    {
      accessorKey: "cvLink",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title="CV url" />
      ),
    },
    {
      accessorKey: "createdAt",
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title="Revenue From Application"
        />
      ),
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title="Revenue From Package" />
      ),
    },
    {
