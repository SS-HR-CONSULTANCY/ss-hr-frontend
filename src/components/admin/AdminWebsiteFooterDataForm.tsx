...
import {
  adminGetWebsiteFooterCurrentData,
  adminUpdateWebsiteFooterData,
} from "@/utils/apis/adminSettingsApi";

const AdminWebsiteFooterDataForm: React.FC = () => {
  const [currentData, setCurrentData] =
    useState<AdminGetFooterCurrentDataResponse | null>(null);
  ...
  const onSubmitFooter: SubmitHandler<FooterSettingsFormValues> = async (
    data,
  ) => {
    try {
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        >
          <FormField
            ...
            register={registerFooter}
            error={footerErrors.address?.message}
          />
          <FormField
            id="location"
            label="Location"
            ...
            register={registerFooter}
            error={footerErrors.location?.message}
          />
          <FormField
            id="phoneIndia"
            label="Phone India"
            placeholder="Enter India phone number"
            register={registerFooter}
            error={footerErrors.phoneIndia?.message}
          />
          <FormField
            id="phoneUAE"
            label="Phone UAE"
            ...
            register={registerFooter}
            error={footerErrors.phoneUAE?.message}
          />
          <FormField
            id="facebookUrl"
            label="Facebook URL"
            ...
            register={registerFooter}
            error={footerErrors.facebookUrl?.message}
          />
          <FormField
            id="xUrl"
            label="X URL"
            ...
            register={registerFooter}
            error={footerErrors.xUrl?.message}
          />
          <FormField
            id="instagramUrl"
            label="Instagram URL"
            ...
            register={registerFooter}
            error={footerErrors.instagramUrl?.message}
          />
          <FormField
            id="companyEmail"
            label="Company Email"
            ...
            register={registerFooter}
            error={footerErrors.companyEmail?.message}
          />
          <FormField
            id="timingInida"
            label="Indian office timing"
            placeholder="Enter Indian office timing"
            register={registerFooter}
            error={footerErrors.timingInida?.message}
          />
          <FormField
            id="timingUae"
            label="UAE office timing"
            placeholder="Enter UAE office timing"
            register={registerFooter}
            error={footerErrors.timingUae?.message}
          />
        ...
        <div className="md:w-1/2 space-y-4 p-4 rounded shadow">
          ...
          {currentData ? (
            <div className="space-y-2 text-sm">
              <p>
                <strong>Address:</strong> {currentData.address}
              </p>
              <p>
                <strong>Location:</strong> {currentData.location}
              </p>
              <p>
                <strong>Phone (India):</strong> {currentData.phoneIndia}
              </p>
              <p>
                <strong>Phone (UAE):</strong> {currentData.phoneUAE}
              </p>
              <p>
                <strong>Email:</strong> {currentData.companyEmail}
              </p>
              <p>
                <strong>Facebook URL:</strong> {currentData.facebookUrl}
              </p>
              <p>
                <strong>X URL:</strong> {currentData.xUrl}
              </p>
              <p>
                <strong>Instagram URL:</strong> {currentData.instagramUrl}
              </p>
              <p>
                <strong>Indian Timing:</strong> {currentData.timingInida}
              </p>
              <p>
                <strong>UAE Timing:</strong> {currentData.timingUae}
              </p>
            </div>
          ) : (
